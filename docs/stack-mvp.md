...
Este registro define a stack mínima recomendada para o **MVP — Fila Digital Presencial Operável**, considerando que o Grupo Boticário já utiliza **React** no front-end e **Node.js com NestJS** no BFF.
