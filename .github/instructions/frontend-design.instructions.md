---
description: "Use when building or editing React UI components, styles, tokens, or any frontend code. Covers design system, tokens, typography, spacing, icons, component decisions, usability heuristics, and tone of voice."
...
- Design tokens (canonical): [brand.ts](../../apps/frontend/src/styles/brand.ts)
- CSS custom properties (mirror): [theme.css](../../apps/frontend/src/styles/theme.css)
- Date/time/duration formatting: [format.ts](../../apps/frontend/src/utils/format.ts)
